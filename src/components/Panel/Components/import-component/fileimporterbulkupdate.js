...
class FileImporterBulkUpdate extends Component {
	constructor(props) {
		super(props);
		this.state = {
			files: [],
	...
	render() {
		let url = environment.API_ENDPOINT + 'fileimporter/request/fileUploadBulkUpdate?bearer=' + globalState.getLocalStorage('auth_token');
		return (
			<Card sectioned>
...
export default FileImporterBulkUpdate;
