...
class Paginate extends React.Component {
	...
	renderInnerPages(currentPage, numPages) {
		...
		segments.previousPages.forEach(page =>
			pagination.push(this.pageToLink(page))
		);
		...
		return times(numPages, i => {
			...
			return (
				<a
					...
					key={page}
					onClick={e =>
						this.handlePageClick(e, null, currentPage, numPages, page)
					}
				>
					{page}
				</a>
		...
		return (
			<div className="rsdt rsdt-paginate">
				...
				<a
					...
					onClick={e =>
						this.handlePageClick(e, "previous", currentPage, numPages)
					}
				>
					Previous
				</a>
